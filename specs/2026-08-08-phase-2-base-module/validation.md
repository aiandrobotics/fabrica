...
- Execute FreeCAD Python API scripts for `part_01_base_module.py` and `part_10_frame_joiner.py` using `freecadcmd`.
...
- Run `check_interference` on `part_01_base_module` and `part_10_frame_joiner` mating pairs.
