...
void test_config_constants(void)
{
    ...
    TEST_ASSERT(BTN1_GPIO == 0, "BTN1_GPIO is GPIO 0");
    TEST_ASSERT(BTN2_GPIO == 4, "BTN2_GPIO is GPIO 4");
    TEST_ASSERT(BTN3_GPIO == 16, "BTN3_GPIO is GPIO 16");
    TEST_ASSERT(BTN4_GPIO == 17, "BTN4_GPIO is GPIO 17");
