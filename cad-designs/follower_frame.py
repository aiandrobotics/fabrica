...
def construct_follower_frame():
    ...
    pts_cav = [
        App.Vector(w - rail_w, knuckle_len, 0),
        App.Vector(w - rail_w, h - knuckle_len, 0),
        App.Vector(rail_w, h - knuckle_len, 0),
    ]
    ...
    pts_cav.append(App.Vector(rail_w, knuckle_len, 0))
    pts_cav.append(App.Vector(w - rail_w, knuckle_len, 0))

    cav_main_face = Part.Face(Part.makePolygon(pts_cav))
