...
| **Follower Sub-Assembly** | [`follower_assembly.py`](file:///Users/intelligentmachine/Documents/workspace/fabrica/cad-designs/follower_assembly.py) | `follower_assembly.step`, `follower_assembly.stl` | Complete Passive Follower sub-assembly uniting frame, flap, frame joiners, and hex coupler pin. |
...
| **Motorized Folding Flap** | [`motorized_flap.py`](file:///Users/intelligentmachine/Documents/workspace/fabrica/cad-designs/motorized_flap.py) | `motorized_flap.step`, `motorized_flap.stl` | Monolithic active flap with continuous Ø13.0mm drive axle, integrated 25T metal servo horn pocket + central M3 retention screw, bottom 8.0mm hex socket, and servo clearance notch. |
| **Motorized Servo Cover** | [`motorized_servo_cover.py`](file:///Users/intelligentmachine/Documents/workspace/fabrica/cad-designs/motorized_servo_cover.py) | `motorized_servo_cover.step`, `motorized_servo_cover.stl` | Quick-release protective housing with dual snap-latch flex tabs, wire strain-relief notch, and convection cooling gills. |
| **Motorized Sub-Assembly** | [`motorized_assembly.py`](file:///Users/intelligentmachine/Documents/workspace/fabrica/cad-designs/motorized_assembly.py) | `motorized_assembly.step`, `motorized_assembly.stl` | Complete Active Motorized sub-assembly uniting frame, active flap, servo cover, joiners, hex coupler pin, and servo reference solid. |
