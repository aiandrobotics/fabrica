...
- **Flat Ventilated Triple-Board Controller Enclosure** (`interface_case.py`): Model protective modular flat rectangular electronics chassis ($220.0 \times 120.0 \times 30.0\text{ mm}$, green) housing 3 circuit boards:
