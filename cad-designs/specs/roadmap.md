...
- **Ventilated Dual-Board Controller Enclosure** (`controller_case.py`): Model protective modular electronics chassis (green) housing 2 circuit boards:
  ...
  - **ESP32 Microcontroller Board (ESP32 DevKit)**: Dedicated internal mounting standoffs ($51.5 \times 28.5\text{ mm}$ footprint) and micro-USB / USB-C external programming port aperture for WiFi/Bluetooth control and robot logic execution.
