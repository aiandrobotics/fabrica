...
### 4. 16 Extended Full-Height Vertical Motor Wire Ports & Integrated Male Dovetail Key
...
- **Integrated External Male Dovetail Key**: Flared male sliding dovetail key integrated directly into the outside rear wall ($Y = 120.0\text{ mm}$ at $X = 55.0\text{ mm}$) with $45^\circ$ lead-in entry chamfers, sliding directly into the female dovetail pocket of any robot base frame module without separate loose joiners and maintaining a 100% solid inner wall (zero internal socket cutouts).
